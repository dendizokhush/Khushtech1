      ...
      {/* Featured Post */}
       <section className="max-w-7xl mx-auto mb-24">
         ...
         >
           ...
           />
           <Link to="/blog/top-10-website-design-trends" className="absolute inset-0 bg-gradient-to-t from-slate-950 to-transparent p-12 flex flex-col justify-end group">
              ...
              <h2 className="text-4xl md:text-5xl font-bold text-white mb-6 max-w-4xl tracking-tight leading-[1.1] group-hover:text-blue-400 transition-colors">The Evolution of Immersive Web Experiences</h2>
        ...
        {posts.map((post, idx) => (
          ...
          >
            <Link to={`/blog/${post.id}`} className="block group">
              ...
              <div className="inline-flex items-center gap-2 text-blue-500 font-bold group-hover:text-blue-400 transition-colors">
                Read More
